...
{
    internal class VistaProduccionViewModel : ViewModelBase
    {
        #region Campos
        ...
        #region Constructor
        public VistaProduccionViewModel()
        {
            SetearFechas();
            Autorizar();
            CargarProducciones();
        ...
        private void CargarProducciones()
        {
            ...
            Producciones = new ObservableCollection<PRODUCCION>(administradorProduccion.ObtenerProducciones(ObtenerFecha(FechaDesde), ObtenerFecha(FechaHasta)));
        ...
        {
            var edicionProduccion = new EdicionProduccion { DataContext = new EdicionProduccionViewModel() };
        ...
        private void Autorizar()
        {
            ...
            EsVisibleVerPdf = Visibility.Collapsed;
        }
        #endregion
    }
}
